...
function toma_datos(){
    ...
    let resultado = 0;
    if (anios.value > 5 ) {
        let mayorA5 = document.createElement("p");
        mayorA5.innerHTML =  `El máximo de años es 5` ;
        document.body.append(mayorA5);
      return;
    } else if (anios.value <= 0) {
        let menorA0 = document.createElement("p");
        menorA0.innerHTML =  `Se necesita mínimo 1 año de pago` ;
        document.body.append(menorA0);  
        return;
    }  else if (monto.value > 100000) {
        let mayorA100000 = document.createElement("p");
        mayorA100000.innerHTML =  `Lamentablemente no contamos con ese dinero` ;
        document.body.append(mayorA100000);;
        return;
    }
